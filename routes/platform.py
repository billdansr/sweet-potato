...
from schemas import PlatformIn, PlatformOut, PlatformsOut, EmptySchema
...
@platform.output(PlatformsOut(many=True), example=PlatformsOut.example())
def read_platforms():
...
@platform.output(PlatformOut, example=PlatformOut.example())
...
@platform.input(PlatformIn, location='json', example=PlatformIn.example())
@platform.output(EmptySchema, status_code=204)
